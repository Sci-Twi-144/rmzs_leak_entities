...
function ENT:Explode()
	...
	self:FireBulletsLua(pos, self:GetForward(), 3, alt and 1 or 3, 1, 1, self.ProjDamage or 26.67, self:GetOwner(), 0.01, alt and "" or "AR2Tracer", BulletCallback, nil, nil, nil, nil, self)
