...
function ENT:Draw()
	...
	if self:GetVelocity() ~= vector_origin then
		...
		render.DrawSprite(pos, 55, 55, Color(255, 128, 0, 100))
		render.SetMaterial(matGlow2)
		render.DrawSprite(pos, 65, 65, Color(255, 128, 64, 100))
