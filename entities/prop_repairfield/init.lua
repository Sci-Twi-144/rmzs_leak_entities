...
function ENT:Think()
	...
	for _, hitent in pairs(util.BlastAlloc(self, owner, pos, self.MaxDistance * (self:GetObjectOwner().FieldRangeMul or 1))) do
		if not hitent:IsValid() or hitent == self then
			continue
		end
