...
SWEP.Description = (translate.Get("desc_tithonus"))
...
SWEP.MaxCharge = 3
SWEP.ChargeTime = 0.45

SWEP.ReloadActivity = ACT_SHOTGUN_PUMP

GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_MAX_SPREAD, -0.455, 1)
GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_MIN_SPREAD, -0.272, 1)

--[[
GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_RELOAD_SPEED, 0.02)
GAMEMODE:AddNewRemantleBranch(SWEP, 1, (translate.Get("wep_triton")), (translate.Get("desc_triton")), function(wept)
