...
if CLIENT then
	...
	SWEP.VElements = {
		["base"] = { type = "Model", model = "models/props/cs_office/water_bottle.mdl", bone = "ValveBiped.Grenade_Body", rel = "", pos = Vector(-1, 0, 0), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
