...
SWEP.VElements = {
	...
	["eye++"] = { type = "Sprite", sprite = "sprites/light_glow02", bone = "ValveBiped.Bip01_Spine4", rel = "spine", pos = Vector(-2.108, 3.815, 32.942), size = { x = 2.072, y = 2.072 }, color = Color(255, 0, 0, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["spine"] = { type = "Model", model = "models/Gibs/HGIBS_spine.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 10), angle = Angle(0, 90, 178), size = Vector(0.899, 0.665, 3.928), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:DrawAds()
	...
	draw.SimpleTextBlurry("Stacks: " .. (self:GetShovelCharge() or 0), "ZSHUDFont", ScrW() - 260 * screenscale, ScrH() - 100 * screenscale, COLOR_WHITE , TEXT_ALIGN_CENTER)
end
