...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, (translate.Get("wep_citadel")), (translate.Get("desc_citadel")), function(wept)
	...
	wept.Recoil = 0 -- retarded

	wept.Pierces = 3
	wept.DamageTaper = 0.73
