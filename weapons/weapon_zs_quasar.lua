...
SWEP.Description = (translate.Get("desc_quasar"))
...
function SWEP:EmitFireSound()
	self:EmitSound("npc/sniper/sniper1.wav", 100, math.random(105, 115), 1.0, CHAN_WEAPON)
end
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, (translate.Get("wep_blazar")), (translate.Get("desc_blazar")), function(wept)
	wept.Primary.NumShots = 3
	wept.Primary.Damage = wept.Primary.Damage * 0.43

	wept.ConeMax = 4
	wept.ConeMin = 1.3
	wept.Pierces = 1

	wept.SpreadPattern = { -- test
		{0, 0},
		{4, -4},
		{-4, -4},
	}
