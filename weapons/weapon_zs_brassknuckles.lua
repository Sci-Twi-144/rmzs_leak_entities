...
SWEP.PrintName = (translate.Get("wep_brassknuckles"))
SWEP.Description = (translate.Get("desc_brassknuckles"))
...
SWEP.PArsenalModel = "models/props_c17/utilityconnecter005.mdl"
