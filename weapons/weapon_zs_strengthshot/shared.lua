...
SWEP.Description = (translate.Get("desc_strengthshot"))
SWEP.Slot = 4
SWEP.SlotPos = 0
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, (translate.Get("wep_defence")), (translate.Get("desc_defence")), function(wept)
	if SERVER then
...
function SWEP:SecondaryAttack()
	...
	if targetent:IsValidLivingHuman() then
