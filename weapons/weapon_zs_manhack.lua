...
SWEP.PrintName = (translate.Get("wep_manhack"))
SWEP.Description = (translate.Get("desc_manhack"))
...
function SWEP:CanPrimaryAttack()
	...
	if not self:GetOwner():IsSkillActive(SKILL_AUTOCONTROL) then
...
function SWEP:PrimaryAttack()
	...
	if SERVER then
		...
		if ent:IsValid() then
			...
			if not owner:HasWeapon(self.ControlWeapon) and not owner:IsSkillActive(SKILL_AUTOCONTROL) then
