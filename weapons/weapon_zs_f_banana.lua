...
if CLIENT then
	...
	SWEP.VElements = {
		["base"] = { type = "Model", model = "models/props/cs_italy/bananna.mdl", bone = "ValveBiped.Grenade_Body", rel = "", pos = Vector(-2, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
