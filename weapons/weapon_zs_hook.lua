...
SWEP.Description = (translate.Get("desc_hook"))
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, (translate.Get("wep_hook_graple")), (translate.Get("desc_hook_graple")), function(wept)
	wept.Weaken = true
...
function SWEP:OnMeleeHit(hitent, hitflesh, tr)
	if SERVER and hitent:IsValid() and hitent:IsPlayer() and hitent:Health() > self.MeleeDamage and not SpawnProtection[hitent] then
