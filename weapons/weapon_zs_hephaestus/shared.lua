SWEP.PrintName = (translate.Get("wep_hephaestus"))
SWEP.Description = (translate.Get("desc_hephaestus"))
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, (translate.Get("wep_prometheus")), (translate.Get("desc_prometheus")), function(wept)
	...
	local function DoRicochet(attacker, hitpos, hitnormal, normal, damage)
		...
		if attacker:IsValid() then
			FORCE_B_EFFECT = true
			attacker:FireBulletsLua(hitpos, 2 * hitnormal * hitnormal:Dot(normal * -1) + normal, 0, 1, 1, 1, damage, nil, nil, "tracer_heph_alt", nil, nil, nil, nil, nil, attacker:GetActiveWeapon())
			FORCE_B_EFFECT = nil
		end
