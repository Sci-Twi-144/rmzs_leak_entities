SWEP.PrintName = (translate.Get("wep_scythe"))
SWEP.Description = (translate.Get("desc_scythe"))
...
function SWEP:StartSwinging()
	...
	self:SendWeaponAnim(self:IsHeavy() and ACT_VM_HITLEFT or ACT_VM_PRIMARYATTACK_2)
	self:GetOwner():GetViewModel():SetPlaybackRate(self.SwingTime * (1 + (1 - (otbl.MeleeSwingDelayMul or 1))) * 1.5)
