...
SWEP.HeatBuildShort = 0.075
SWEP.HeatBuildLong = 0.06
SWEP.HeatVentShort = 0.18
SWEP.HeatVentLong = 0.15
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 2, (translate.Get("wep_muon")), (translate.Get("desc_muon")), function(wept)
	wept.Primary.Damage = 24
	wept.HeatBuildShort = 0.06
	wept.HeatBuildLong = 0.05
	wept.GluonDamage = function(self)
		return wept.Primary.Damage + (self:GetLongHeat() * 0.55 * wept.Primary.Damage)
	end
