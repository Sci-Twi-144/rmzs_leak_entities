...
SWEP.PrintName = (translate.Get("wep_longsword"))
SWEP.Description = (translate.Get("desc_longsword"))
...
SWEP.StaminaConsumption = 11

SWEP.AllowQualityWeapons = true

GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_FIRE_DELAY, -0.125)
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, (translate.Get("wep_katana")), (translate.Get("desc_katana")), function(wept)
	wept.ViewModel = "models/weapons/c_katana.mdl"
	wept.WorldModel = "models/weapons/w_katana.mdl"

	wept.HoldType = "melee2"
	wept.SwingTime = 0
	wept.SwingRotation = Angle(0, -20, -40)
	wept.SwingOffset = Vector(10, 0, 0)
	wept.SwingHoldType = "melee"
	wept.HitDecal = "Manhackcut"

	wept.HitAnim = ACT_VM_MISSCENTER
	
	wept.BlockRotation = Angle(0, 15, -40)
	wept.BlockOffset = Vector(3, 9, 4)

	wept.BlockStability = 0.35
	wept.BlockReduction = 20
	wept.StaminaConsumption = 7

	wept.Primary.Delay = wept.Primary.Delay * 0.8
	wept.MeleeDamage = wept.MeleeDamage * 1.1
	wept.MeleeRange = wept.MeleeRange * 0.945
	wept.MeleeSize = 2
	wept.MeleeKnockBack = 100

	wept.WalkSpeed = SPEED_NORMAL

	wept.HitGesture = ACT_HL2MP_GESTURE_RANGE_ATTACK_MELEE
	wept.MissGesture = wept.HitGesture
	...
	wept.MeleeSwing = function(self)
		BaseClass.MeleeSwing(self)
	end

	wept.MeleeHitEntity = function(self, tr, hitent, damagemultiplier, damage)
		BaseClass.MeleeHitEntity(self, tr, hitent, damagemultiplier, damage)
	end
	...
	wept.PlayHitSound = function(self)
...
branch.Killicon = "weapon_zs_katana"
