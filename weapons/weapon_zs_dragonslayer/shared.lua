...
SWEP.PrintName = (translate.Get("wep_dragonslayer")) -- Dragonslayer
SWEP.Description = (translate.Get("desc_dragonslayer")) -- Больше похож на булаву с лезвием, чем на настоящий меч.
...
SWEP.MeleeDamage = 309
SWEP.MeleeRange = 87
SWEP.MeleeSize = 6

SWEP.Primary.Delay = 1.85
...
function SWEP:PlaySwingSound()
	self:EmitSound("weapons/iceaxe/iceaxe_swing1.wav", 75, math.random(23, 29))
end

function SWEP:PlayHitSound()
	self:EmitSound("weapons/melee/frying_pan/pan_hit-0"..math.random(4)..".ogg", 100, math.random(33, 33), 1, CHAN_WEAPON)
end
