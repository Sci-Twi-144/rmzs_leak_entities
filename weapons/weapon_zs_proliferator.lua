...
SWEP.Description = (translate.Get("desc_proliferator"))
SWEP.Slot = 2
SWEP.SlotPos = 0
...
SWEP.Primary.Sound = "weapons/zs_scar/scar_fire1.ogg"
...
function SWEP:ShootBullets(dmg, numbul, cone)
	...
	for i = 1, numbul do
		...
		owner:FireBulletsLua(owner:GetShootPos(), angle:Forward(), cone/recp, 1, 1, 1, dmg, nil, self.Primary.KnockbackScale, self.TracerName, self.BulletCallback, self.Primary.HullSize, nil, self.Primary.MaxDistance, nil, self)
	end
