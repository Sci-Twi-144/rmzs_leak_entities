...
SWEP.Description = (translate.Get("desc_artemis"))
...
SWEP.SoundFireLevel = 100
SWEP.SoundPitchMin = 150
SWEP.SoundPitchMax = 160
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, (translate.Get("wep_actaeon")), (translate.Get("desc_actaeon")), function(wept)
