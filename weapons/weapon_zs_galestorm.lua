...
SWEP.PrintName = (translate.Get("wep_galestorm"))
SWEP.Description = (translate.Get("desc_galestorm"))
SWEP.Slot = 2
SWEP.SlotPos = 0
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, (translate.Get("wep_whirlwind")), (translate.Get("desc_whirlwind")), function(wept)
