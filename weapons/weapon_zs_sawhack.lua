...
SWEP.Description = (translate.Get("desc_sawhack"))
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "Razorhack", translate.Get("desc_razorhack"), function(wept)
	wept.Primary.Delay = wept.Primary.Delay * 0.85
