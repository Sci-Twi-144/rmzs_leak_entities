...
function EFFECT:Render()
	...
	for i = 0, nlen * (1 - delta), 32 do
		...
		render.DrawBeam(prevspinpos, spinbeampos, 4, texcoord + i, texcoord + 1 + i, Color(240, 230, 20, self.Color.a))
		render.DrawBeam(prevspinpos2, spinbeampos2, 4, texcoord + i, texcoord + 1 + i, Color(240, 230, 20, self.Color.a))
