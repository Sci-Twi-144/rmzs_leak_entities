function EFFECT:Init(data)
	...
	--sound.Play("ambient/explosions/explode_"..math.random(1,5)..".wav", pos, 80, math.random(135, 160), 0.2)

	if ShouldDrawGlobalParticles(pos) then
		local emitter = ParticleEmitter(pos)
		emitter:SetNearClip(48, 60)
...
function EFFECT:Render()
	...
	render.DrawSprite(self.Start, 600, 600, Color(255, 210, 170, self.Alpha))
end
